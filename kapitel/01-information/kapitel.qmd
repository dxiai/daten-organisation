...
Die Arbeit mit Daten schliesst immer die Frage ein, ob diese Daten relevante Informationen verbergen. Dazu müssen zwei Konzepte erfasst werden:  
...
::: {.callout-note}
## Merke
Durch *Äquivokation* gehen Informationen beim Übertragen verloren.
:::
...
Zusätzlich muss das *Rauschen* des Kanals berücksichtigt werden. Später wurde das Modell um die *Äquivokation* erweitert [@shannon_communication_1949]. Sowohl das Rauschen als auch die Äquivokation müssen eigenständig berücksichtigt werden, weil diese die Kommunikation unkontrolliert beeinflussen. Aus diesen Überlegungen ergibt sich das Kommunikationschema in @fig-shannon-model.
...
: Darstellung von Zahlenwerten in verschiedenen Zahlensystemen {#tbl-darstellung-zahlenwerte}
...
4. Beliebige Symbole können als Zahlenwerte abgebildet werden . 
